...
class Differential:
    ...
    def mutate(self, F, pop, bestInd, ind_pos, probas):
        mutant, formula, strat_vector = strategy.auto_strategy(F, pop, bestInd, ind_pos, probas)
    ...
    def write_res(self, folderName, name, mode, n_pop, n_gen, cross_proba, F, learning_rate, mut_proba, mut_shift,
                  ...
                  bestScoreA, bestScoreP, bestScoreR, bestScoreF, bestModel, probas, strat, debut, out, yTps):
    ...
    def natural_selection(self, part, n_pop, n_gen, cross_proba, F, learning_rate, mut_proba, mut_shift, data,
        ...
        for mode in part:
            ...
            probas = self.create_proba(size=7)
            ...
            for generation in range(n_gen):
                ...
                for i in range(n_pop):
                    ...
                    # mutation
                    mutant, formula, strat_vector = self.mutate(F, pop, bestInd, i, probas)
                ...
                probas = self.update_proba(bestStrat, probas, learning_rate)
                ...
                self.write_res(folderName=folderName, name=self.data_name, mode=mode, n_pop=n_pop, n_gen=n_gen,
                               ...
                               mut_shift=mut_shift, strat=bestFormula, y1=y1, y2=y2, yX=yX, colMax=colMax,
                               ...
                               probas=probas, debut=debut, out=print_out, yTps=yTps)
    ...
    def init(self, n_pop, n_gen, cross_proba, F, learning_rate, mut_proba, mut_shift, data, dummiesList,
